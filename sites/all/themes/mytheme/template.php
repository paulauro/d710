 ...
 */
function mytheme_node_add_list($variables) {
 ...
 */
function mytheme_admin_block_content($variables) {
  $content = $variables['content'];
  $output = '';
  if (!empty($content)) {
 ...
 */
function mytheme_tablesort_indicator($variables) {
...
function mytheme_css_alter(&$css) {
  ...
  if (isset($css['misc/vertical-tabs.css'])) {
    $css['misc/vertical-tabs.css']['data'] = drupal_get_path('theme', 'mytheme') . '/vertical-tabs.css';
    $css['misc/vertical-tabs.css']['type'] = 'file';
  }
  if (isset($css['misc/vertical-tabs-rtl.css'])) {
    $css['misc/vertical-tabs-rtl.css']['data'] = drupal_get_path('theme', 'mytheme') . '/vertical-tabs-rtl.css';
