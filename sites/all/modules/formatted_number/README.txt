...
The Formatted Number module defines numeric types where thousands separator
...
- Goto Administer > Modules to install this module.

- Create or edit content types and start adding Money fields. :)

For more details, see: http://drupal.org/documentation/install/modules-themes
